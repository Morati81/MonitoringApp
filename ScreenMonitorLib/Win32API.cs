...
namespace ScreenMonitorLib
{
    ...
    [Flags]
    public enum TokenPrivilege : uint
    {
    ...
    public static class Win32API
    {
        ...
        [
           DllImport("kernel32.dll",
              ...
              CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall), SuppressUnmanagedCodeSecurityAttribute
        ]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport("User32.dll", SetLastError = true)]
        internal static extern IntPtr OpenWindowStation(String lpszWinSta, bool fInherit, int dwDesiredAccess);
      
        [DllImport("User32.dll", SetLastError = true)]
        internal static extern IntPtr OpenDesktop(String lpszDesktop, int dwFlags, bool fInherit, int dwDesiredAccess);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool SetProcessWindowStation(IntPtr hWindowStation);
        ...
        internal static extern int RpcImpersonateClient(IntPtr rpcBindingHandle);

        [DllImport("rpcrt4.dll")]
        internal static extern int RpcRevertToSelf();

        [DllImport("User32.Dll", SetLastError = true)]
        public static extern void GetClassName(IntPtr hWnd, [MarshalAs(UnmanagedType.LPStr)] System.Text.StringBuilder param, int length);
        ...
        [DllImport("user32")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PrintWindow(IntPtr hWnd, IntPtr dc, uint flags);
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool AppendMenu(IntPtr hMenu, Int32 wFlags, IntPtr wIDNewItem, string lpNewItem);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal extern static bool DeleteObject(IntPtr hDc);
